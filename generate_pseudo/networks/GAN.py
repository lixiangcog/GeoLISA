...
class OutputDiscriminator(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            2, filter_num_list[0], kernel_size=4, stride=2, padding=2, bias=False
        )
...
class BoundaryDiscriminator(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            1, filter_num_list[0], kernel_size=4, stride=2, padding=2, bias=False
        )
        self.conv2 = nn.Conv2d(
            filter_num_list[0],
            filter_num_list[1],
...
class BoundaryEntDiscriminator(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            3, filter_num_list[0], kernel_size=4, stride=2, padding=2, bias=False
        )
        self.conv2 = nn.Conv2d(
            filter_num_list[0],
            filter_num_list[1],
