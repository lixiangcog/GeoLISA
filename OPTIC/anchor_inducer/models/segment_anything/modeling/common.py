    ...
    def __init__(
        ...
        if size_in == size_out:
            ...
            if n.is_integer():
                ...
                raise ValueError(
                    f"size_out must be a multiple of size_in, got {size_out} and {size_in}"
                )
            ...
            for _ in range(n):
                self.reshaper.extend(
                    [
                        nn.ConvTranspose2d(
                            channel_in, channel_in // 2, kernel_size=2, stride=2
                        ),
            ...
            if n.is_integer():
                ...
                raise ValueError(
                    f"size_in must be a multiple of size_out, got {size_in} and {size_out}"
                )
