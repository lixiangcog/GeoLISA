...
anchor_seg_oc="""
    The optic cup is the central depression within the optic disc;its outer boundary is the cup margin, which typically coincides with the ring-like trajectory formed by the points where vessels bend or disappear within the disc.
    Please describe the size, shape, color and the position within the image about optic cup in summary.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_in", type=str, default="fundus_result_oc.json")
    parser.add_argument("--json_out", type=str, default="fundus_result_oc_after.json")
